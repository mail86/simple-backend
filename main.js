const songs = {
  ...
  Malaysia: [
    { title: "Apakah Itu Cinta", src: "Malaysia/Apakah Itu Cinta.mp3" },
    { title: "Cinta Dimana Kini", src: "Malaysia/Cinta Dimana Kini.mp3" },
    { title: "cinta itu buta", src: "Malaysia/cinta itu buta.mp3" },
    { title: "Di Perjalanan", src: "Malaysia/Di Perjalanan.mp3" },
    { title: "Gubuk Jadi Istana", src: "Malaysia/Gubuk Jadi Istana.mp3" },
    { title: "Ku Puja Puja", src: "Malaysia/Ku Puja Puja.mp3" },
    {title: "Satu Hati Sampai mati", src: "Malaysia/Satu Hati Sampai mati.mp3"},
    { title: "Terpaksa Aku Lakukan", src: "Malaysia/Terpaksa Aku Lakukan.mp3" },
    { title: "Tiara", src: "Malaysia/Tiara.mp3" },
    { title: "UKS", src: "Malaysia/UKS.mp3" },
    { title: "Biarkan Cintamu Berlalu", src: "Malaysia/Biarkan Cintamu Berlalu.mp3" },
    { title: "Bintang Kehidupan", src: "Malaysia/Bintang Kehidupan.mp3" },
    { title: "buih jadi permadani", src: "Malaysia/buih jadi permadani.mp3" },
    { title: "Cinta Diantara Kita", src: "Malaysia/Cinta Diantara Kita.mp3" },
    { title: "cinta itu buta", src: "Malaysia/cinta itu buta.mp3" },
    { title: "Di Hari Persandingan", src: "Malaysia/Di Hari Persandingan.mp3" },
    { title: "Duri Terlindung", src: "Malaysia/Duri Terlindung.mp3" },
    { title: "Gerimis Mengundang", src: "Malaysia/Gerimis Mengundang.mp3" },
    ...
    { title: "Seberkas Sinar", src: "Malaysia/Seberkas Sinar.mp3" },
    { title: "Sheila", src: "Malaysia/Sheila.mp3" },
    { title: "Suci Dalam Debu", src: "Malaysia/Suci Dalam Debu.mp3" },
    { title: "Tinggallah Ku Sendiri", src: "Malaysia/Tinggallah Ku Sendiri.mp3" },   
  ],
  Campuran: [
